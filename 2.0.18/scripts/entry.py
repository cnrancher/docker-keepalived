...
argparser.add_argument('--nopreempt',
                       action='store_true',
                       help='Set nopreempt')
argparser.add_argument('--unicast',
                       action='store_true',
                       help='Set unicast')
...
argparser.add_argument('--check-timeout','-t',
                       action='store',
                       nargs='?',
                       type=int,
                       default=2,
                       help='The amount of timeout checks required to fault, (default 2)')
argparser.add_argument('--check-weight','-w',
                       action='store',
                       nargs='?',
                       type=int,
                       default=1,
                       help='The amount of weight checks required to fault, (default 1)')
argparser.add_argument('--track-iface',
                       action='store',
                       nargs='?',
...
check_script = {
    ...
    'timeout'       : args.check_timeout, # int
    'weight'        : args.check_weight, # int
...
template_dict = { 'context' : { # Subsitutions to be performed
                                ...
                                'is_nopreempt'        : args.nopreempt,
                                'is_unicast'          : args.unicast,
                                'unicast_peer_ip'     : args.unicast_peer_ip,
                                'unicast_src_ip'      : args.unicast_src_ip,
                                'auth_pass'           : auth_pass,
...
child_path = ["/usr/local/sbin/keepalived","--dont-fork","--log-console"]
